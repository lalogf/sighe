...
<script>
  ...
  function Loguearse(){
	...
	if($user==""){
		$("#DivMensaje").show(500);
		$("#TituloMensaje").text("Ingrese Usuario por favor ..");$("#IdUsuario").focus();exit;
		}
	if($pass==""){
		$("#DivMensaje").show(500);
...
<div style="background-image:url(LIBRERIAS/IMAGENES/index.png);width:895px;height:500px;margin:5% auto; padding:0px; border-radius:10px; box-shadow:5px 5px 20px #000;">
    ...
    <div style="float:right;width:260px;margin-right:20px;"><p><span style="font-weight:bold;color:#00F; text-align:center">ACCSEO AL SISTEMA</span></p></div>
    <div class="clear"></div>
...
<div id="DivMensaje" style="display:none" class="mensajeError" >
 <p><strong style="color:#FFF; font-size:20px"> &nbsp;&nbsp;Mensaje de error</strong></p><hr />
 <table width="250" border="0">
    <tr>
       <td><p>&nbsp;&nbsp;&nbsp;<span id="TituloMensaje" style="color:#FFF"></span></p></td>
    </tr>
    <tr><td><hr /></td></tr>
    <tr>
       <td align="center"><p><input type="button" value="Aceptar" onclick="javascript:CerrarMensaje()" class="entrar"/></p></td>
    </tr>
 </table>
</div>
</body>
